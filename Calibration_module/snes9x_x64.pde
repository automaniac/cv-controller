          ...
          if (count[i] > 0) {
                if(i%2!=0){
                  if(avgY[i]<=player[i].jumpH && player[i].localizH!=CIMA){
                   ...
                   } else if(avgX[i]<=player[i].rightW && player[i].localizW!=DIREITA){
                   ...
                   }else  if(avgX[i]>=player[i].leftW && player[i].localizW!=ESQUERDA){
                   ...
                   }else if(avgY[i]<player[i].leftW && avgY[i]>player[i].rightW && player[i].localizW!=CENTRO){
